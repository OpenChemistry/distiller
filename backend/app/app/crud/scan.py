...
def get_scans(
    ...
    query = _get_scans_query(
        db, skip, limit, scan_id, state, created, has_haadf, start, end, microscope_id, sha
    )
...
def create_scan(db: Session, scan: Union[schemas.Scan4DCreate, schemas.ScanFromFile], image_path: Union[str, None] = None):
